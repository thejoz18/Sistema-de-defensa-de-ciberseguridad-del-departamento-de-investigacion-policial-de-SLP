##Este modulo crea el trafico normal antes de que exista un ataque.
##Sirve como punto de partida para comparar actividad normal contra actividad anomala.
...
def generar_trafico_normal(segundo):
    ...
    ##Este bloque se guarda completo para que despues m00 y m04 lo puedan analizar.
    paquete = {
