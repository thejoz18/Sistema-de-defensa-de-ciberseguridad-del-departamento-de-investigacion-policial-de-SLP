##Este modulo genera imagenes PNG con los datos del historial.
##Cada grafica se guarda en la carpeta pdi_slp_graficas.
...
def generar_graficas(historial, carpeta="pdi_slp_graficas"):
    ...
    ##A partir de aqui se separan los datos del historial en listas simples.
    ##No se comenta cada historial completo porque ya viene armado desde m00.
    ...
    def poner_leyenda_izquierda(ax):
        ##Configuramos la leyenda para que combine con el fondo oscuro.
        ax.legend(
            loc="upper left",
            facecolor="#0d1117",
            edgecolor="#1e2a38",
    ...
    def generar_onda_envio(tiempo, valores, max_regular=500, intervalo=5, puntos_por_intervalo=80):
        ##Esta onda sirve como patron visual de comportamiento regular.
