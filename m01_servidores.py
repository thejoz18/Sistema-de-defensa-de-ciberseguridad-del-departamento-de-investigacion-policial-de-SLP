##Este modulo guarda los datos base y los umbrales del sistema.
##Aqui no se ejecuta la simulacion, solo se dejan listas y valores para otros modulos.
...
##Solo se comenta la lista completa porque cada elemento es un nombre de expediente.
tipos_expediente = [
